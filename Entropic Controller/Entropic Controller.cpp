...
vector<particle> protons; //Vector of proton particles, for calculating electric field and strong interaction
vector<particle> neutrons; //Vector of neutron particles, for calculating strong interaction
